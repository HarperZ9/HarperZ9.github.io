    ...
    },
    {
      ...
      "routes": [
        ...
        },
        {
          ...
          "href": "flywheel.html",
          "primary": true,
          "summary": "Flywheel is a self-hostable, model-agnostic AI workstation and coding harness: run any frontier or local model behind one interface, with the Rowan desktop assistant, a permission-gated coding agent, and fifteen built-in lanes (ten bundle natively) for research, memory, and writing. Its check-output command grades an answer against the source that decides it, ships finance, medicine, and law packs, and can emit a Lean 4 proof; accepted results carry sealed, re-derivable receipts an independent witness re-runs offline. Data stays local; the code is source-available under FSL-1.1-MIT.",
          "maturity": "shipped",
          "searchText": "Flywheel Flywheel is a self-hostable, model-agnostic AI workstation and coding harness: run any frontier or local model behind one interface, with the Rowan desktop assistant, a permission-gated coding agent, and fifteen built-in lanes (ten bundle natively) for research, memory, and writing. Its check-output command grades an answer against the source that decides it, ships finance, medicine, and law packs, and can emit a Lean 4 proof; accepted results carry sealed, re-derivable receipts an independent witness re-runs offline. Data stays local; the code is source-available under FSL-1.1-MIT. agent workflow orchestration model-neutral execution receipt-backed evaluation endpoint profile probe controls synthetic workflow environment checks verified-inference platform and desktop client stable Python engine v1.0.1; unsigned Windows desktop v1.0.1; ten Python lanes bundle from vendored source; no measured accuracy uplift over single-shot; clean-machine, mobile, and node-lane bundling not claimed shipped Agent systems Evaluation and verification Developer infrastructure shipped Flywheel is a self-hostable, model-agnostic AI workstation and coding harness: run any frontier or local model behind one interface, with the Rowan desktop assistant, a permission-gated coding agent, and fifteen built-in lanes (ten bundle natively) for research, memory, and writing. Its check-output command grades an answer against the source that decides it, ships finance, medicine, and law packs, and can emit a Lean 4 proof; accepted results carry sealed, re-derivable receipts an independent witness re-runs offline. Data stays local; the code is source-available under FSL-1.1-MIT."
        },
        {
          "label": "Telos",
        ...
        {
          "label": "An open letter on checking the machines",
          "href": "checking-the-machines.html",
          "summary": "A signed open letter on re-derivable verification: check an AI-assisted result without trusting whoever produced it. AI-assisted, author-directed.",
          "primary": false,
          "searchText": "An open letter on checking the machines A signed open letter on re-derivable verification: check an AI-assisted result without trusting whoever produced it. AI-assisted, author-directed. An open letter on checking the machines An open letter on checking the machines A signed open letter on re-derivable verification: check an AI-assisted result without trusting whoever produced it. AI-assisted, author-directed."
        }
      ],
      "prefixes": [
        "systems/",
  ...
  "systems": [
    {
      "id": "flywheel",
      "name": "Flywheel",
      "purpose": "Flywheel is a self-hostable, model-agnostic AI workstation and coding harness: run any frontier or local model behind one interface, with the Rowan desktop assistant, a permission-gated coding agent, and fifteen built-in lanes (ten bundle natively) for research, memory, and writing. Its check-output command grades an answer against the source that decides it, ships finance, medicine, and law packs, and can emit a Lean 4 proof; accepted results carry sealed, re-derivable receipts an independent witness re-runs offline. Data stays local; the code is source-available under FSL-1.1-MIT.",
      "useCases": [
      ...
      "placement": "featured",
      "accessMode": "install",
      "entryCommand": "pip install flywheel-verify",
      "verificationCommand": "flywheel lanes --probe; flywheel check-output --contract task.contract.json --answer answer.json --allow-commands",
      "evidence": [
        {
          "id": "flywheel-release-v1-0-1",
          "type": "release",
          "label": "Flywheel v1.0.1",
          "href": "https://github.com/HarperZ9/flywheel/releases/tag/v1.0.1",
          "date": "2026-09-19",
          "status": "verified",
          "summary": "The v1.0.1 GitHub release, titled Flywheel 1.0.1, was published at 2026-09-19T20:44:28Z, and the v1.0.1 tag resolves to source commit 2efac00c0fc8a6c7d07097d0f27ac6f04a26ad23. The release attaches Flywheel-Setup-1.0.1-x64.exe at 56,164,323 bytes with SHA-256 95c616d667b1d3232a8c56a080e4de2112428000a0635eab60427b4983e90d37 and frozen-gateway-smoke.json at 6,730 bytes with SHA-256 5d94e797f5c6c016b5a6bddc0b59741f4b73ae7f54c158649181ecce8e444f67. The frozen gateway smoke receipt reports PASS for expected version 1.0.1 and records all ten bundled Python lanes admitting at exit code 0. Ten Python lanes (gather, crucible, index, forum, plexus, mneme, canon, chorus, relay, accountable-surface) carry a hash-pinned source payload and launch from vendored source on a clean machine; the staged source is hash-checked before launch, each admission exposes only that lane's status and doctor health tools, and the accept path is untouched. On the shipped benchmark the verified loop shows no measured accuracy uplift over single-shot; the interval includes zero, and the demonstrated value is the re-derivable receipt and the containment. These checks do not establish installer integration, clean OS compatibility, Flutter UI rendering, native identity registration, Relay model-backed task execution, production Bulletin posting, general model uplift, physical Android/mobile acceptance, or native bundling of the node lanes learn and telos or calibrate-pro, which resolve from a source checkout today. The Windows desktop installer is unsigned."
        },
        {
          "id": "flywheel-pypi-v1-0-1",
          "type": "release",
          "label": "flywheel-verify 1.0.1 on PyPI",
          "href": "https://pypi.org/project/flywheel-verify/1.0.1/",
          "date": "2026-09-19",
          "status": "verified",
      ...
      "limitations": [
        "Receipts establish witnessed actions and checks, not general model correctness. A receipt proves a check reproduces; it does not prove the answer is true of the world.",
        "On the shipped benchmark the verified loop shows no measured accuracy uplift over single-shot; the interval includes zero. The demonstrated value is the re-derivable receipt and the containment.",
        "The v1.0.1 Python package release, Windows installer asset, and frozen gateway smoke receipt do not establish installer integration, clean OS compatibility, Flutter UI rendering, native identity registration, Relay model-backed task execution, production Bulletin posting, general model uplift, physical Android/mobile acceptance, or universal verifier completeness.",
        "Native lane bundling covers ten Python lanes from hash-pinned vendored source. The node lanes learn and telos, and calibrate-pro, resolve from a source checkout today and are not claimed as natively bundled; articulate installs from PyPI (articulate-writing 0.2.0).",
        "The v1.0.1 Windows desktop installer is unsigned. Matching the published SHA-256 checks bytes only; it does not authenticate the publisher or prove clean-machine installation.",
      ...
      "releaseState": "stable Python engine v1.0.1; unsigned Windows desktop v1.0.1; ten Python lanes bundle from vendored source; no measured accuracy uplift over single-shot; clean-machine, mobile, and node-lane bundling not claimed"
    },
    {
...
`),fe=T.systems;fe.filter(e=>e.placement===`featured`);var pe=T.domains,me=fe.flatMap(e=>e.evidence.map(t=>({...t,systemId:e.id}))).sort((e,t)=>t.date.localeCompare(e.date));function he(e){return fe.find(t=>t.id===e)}var E=`{
