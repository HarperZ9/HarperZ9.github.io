  ...
  "families": [
    {
      ...
      "routes": [
        ...
        },
        {
          ...
          "href": "person.html",
          "primary": false,
          "summary": "The personal story behind the work: optional, and kept apart on purpose. The tools stand on their own; this is how they came to be, and who they're really for.",
          "searchText": "Zain Dana Harper The personal story behind the work: optional, and kept apart on purpose. The tools stand on their own; this is how they came to be, and who they're really for. Zain Dana Harper The person behind it The personal story behind the work: optional, and kept apart on purpose. The tools stand on their own; this is how they came to be, and who they're really for."
        },
        {
    ...
    },
    {
      ...
      "routes": [
        ...
        },
        {
          ...
          "maturity": "shipped",
          "searchText": "EMET EMET verifies whether bytes reaching a model, reviewer, or pipeline still match their claimed source. It anchors and compares content, neutralizes embedded authority, audits drift, and mints portable closed-verdict receipts across four implementations. byte-integrity verification proof-packet witnessing cross-implementation conformance cross-implementation integrity witness stable v1.2.0 shipped Evaluation and verification Security and privacy Developer infrastructure shipped EMET verifies whether bytes reaching a model, reviewer, or pipeline still match their claimed source. It anchors and compares content, neutralizes embedded authority, audits drift, and mints portable closed-verdict receipts across four implementations."
        },
        {
          "label": "Proof Surface",
  ...
  "systems": [
    {
      ...
      "placement": "featured",
      "accessMode": "install",
      "entryCommand": "python -m pip install flywheel-verify==0.6.1; flywheel up",
      "verificationCommand": "flywheel lanes --probe; service-desk-incident-env verify RETURNED_ARTIFACT_DIR --recompute --json",
      "evidence": [
        {
          "id": "flywheel-release-v0-6-1",
          "type": "release",
          "label": "Flywheel v0.6.1",
          "href": "https://github.com/HarperZ9/flywheel/releases/tag/v0.6.1",
          "date": "2026-09-09",
          "status": "verified",
          "summary": "The v0.6.1 GitHub release was published at 2026-09-09T13:06:27Z and resolves to source commit 2a86c0a8f2da651bceb0bda4c1b1a74379696a39. The release adds exact endpoint profile selection, generation-call budgets before endpoint I/O, descriptor custody for private artifact operations, Linux refusals for Windows-drive 9p/v9fs and unclassified filesystem paths in private artifact operations, and a common E2E journey runner. Release-source validation reported 8,368 Python tests passed and 55 were skipped; distribution verification found all 635 packaged harness entries matched source Git blobs. Ten fresh installed wheel controls passed, including seven expected refusals, without generating model output. These checks do not establish general model uplift, production ServiceNow compatibility, physical Android/mobile acceptance, provider-native session migration, arbitrary provider-native session resume, clean-machine installation, or universal verifier completeness. The v0.6.1 Windows installer is not published."
        },
        {
          "id": "flywheel-pypi-v0-6-1",
          "type": "release",
          "label": "flywheel-verify 0.6.1 on PyPI",
          "href": "https://pypi.org/project/flywheel-verify/0.6.1/",
          "date": "2026-09-09",
          "status": "verified",
          "summary": "PyPI serves flywheel-verify 0.6.1. The wheel is 1,703,955 bytes with SHA-256 5f39615b741489a167815e6d977b414dcb763ec02b645fa20cfd7a153f923e76; the source archive has SHA-256 78dd99cffbbfb3ab986b69f091e3b56258b391bbf26e64ba095ab08ab80bc764. PyPI JSON digests matched the downloads, and CI and PyPI bytes were equal. Wheel fidelity checks found 635 of 635 packaged harness entries and 632 of 632 Python modules matched source Git blobs. Public wheel controls passed 10 of 10, including expected-failure controls; endpoint reports admitted 0 true and 5 false, and generated 0 endpoint rows. This does not prove source truth, claim support, complete coverage, downstream model use, absence of sensitive material, or clean-machine installation."
        },
        {
      ...
      "limitations": [
        ...
        "The v0.6.1 Python package release and Service Desk controls do not establish model uplift, production ServiceNow compatibility, arbitrary provider-native session resume, provider-native session migration, clean-machine installation, physical Android/mobile acceptance, or universal verifier completeness.",
        "The v0.6.1 Windows installer is not published here; the previous unsigned Windows desktop build remains v0.6.0.",
      ...
      "releaseState": "stable Python engine v0.6.1; previous unsigned Windows desktop v0.6.0; clean-machine and mobile acceptance not claimed"
    },
    {
      ...
      "releaseState": "GitHub add-on 0.2.0 and offline report examples; requires Flywheel engine 0.6.1; no PyPI publication claimed"
    },
    {
      "id": "telos",
      "name": "Telos",
