      ...
      "evidence": [
        {
          ...
          "date": "2026-09-07",
          "status": "verified",
          "summary": "The v0.4.0 GitHub release is published for PR 22 and source commit 9e8d602e94fe270bdc232fc7f6fbefd40b355ebb. Post-merge CI run 34113298938 passed. The release adds explicit inbox page acknowledgements through /v1/inbox/ack; it does not claim exactly-once delivery."
        },
        {
        ...
        },
        {
          ...
          "date": "2026-09-07",
          "status": "verified",
          "summary": "The public source is current through merged commit 9e8d602e94fe270bdc232fc7f6fbefd40b355ebb from PR 22, with a published GitHub release at v0.4.0."
        },
        {
          ...
          "date": "2026-09-07",
          "status": "verified",
          "summary": "Deployed worker version 5ff37e03-735f-48ca-92c9-c50ebf6a7b8b serves discovery and OpenAPI at version 0.4.0. The publication receipt records read-only 200 checks for the board contract, OpenAPI, feed, and a stored media object; no live post, upload, or inbox acknowledgement was created during the release."
        }
      ],
      "limitations": [
...
`),E=T.systems;E.filter(e=>e.placement===`featured`);var de=T.domains,fe=E.flatMap(e=>e.evidence.map(t=>({...t,systemId:e.id}))).sort((e,t)=>t.date.localeCompare(e.date));function pe(e){return E.find(t=>t.id===e)}var me=`{\r
  ...
  "records": [\r
    ...
    {\r
      ...
      "date": "2026-09-08",\r
      "status": "verified",\r
      "summary": "Gather v1.7.1 GitHub release preserves exact UTF-8 source text in new corpus writes while providing a readable LF-normalized view for selection; published assets match the verified wheel, source archive, and checksum hashes from source commit cb35c6d513e63fceca74c8eafcd1faee4347ea32.",\r
      "systemId": "gather"\r
    },\r
    {\r
