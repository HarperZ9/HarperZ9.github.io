  ...
  "families": [
    {
      ...
      "routes": [
        ...
        },
        {
          ...
          "href": "resume.html",
          "primary": false,
          "summary": "Current resumes for systems engineering, developer operations, and field operations, plus a full CV.",
          "searchText": "Zain Dana Harper Resumes Support, developer operations, and software quality AI systems, evaluation, and Python tooling Arboriculture, field operations, and estimating Full CV and portfolio Research and contribution record Using the files Contact Current resumes for systems engineering, developer operations, and field operations, plus a full CV. Zain Dana Harper Zain Dana Harper | Resumes Current resumes for systems engineering, developer operations, and field operations, plus a full CV."
        },
        {
          "label": "Full CV",
          "href": "cv.html",
          "primary": false,
          "summary": "Full Curriculum Vitae resume and source-matched downloads. Updated 2026-09-20.",
          "searchText": "Zain Dana Harper Profile Professional Experience Independent Systems Engineer | Independent practice Freelance Technical Writer, Documentation, and Product Operations Commercial Arboriculture and Field Operations | Legendary Tree Technical Networking Support | Xbox/Microsoft contract Programming Background AI Platform and Agent Systems Flywheel | Model-agnostic AI workstation and coding harness Accountable Surface | Governed actions and computer-use adapters Articulate | Writing analysis and accountable editing Agent tools, memory, and coordination Evaluation, Systems, and Security Engineering Terminal State Fixtures and Crucible EMET | Byte-integrity witnessing BuildLang | Rust compiler and developer tooling Phantom | Hardware-identity inspection and reversible system changes Controlled assessment and operator tooling Research intake and workspace tooling Graphics, Color, and Runtime Work Selected Open-Source Contributions Technical Competencies Working Practice Research Agenda Selected Publications and Research Records EMET: An Authority-Incapable Byte-Level Integrity Witness BuildLang: Accountable Compute via Typed Capability Effects Witnessed Independence: Recording Whether a Verifier Graded Its Own Work Proof Packets: A Derive-Don&#x27;t-Trust Envelope for Accountable Agent Actions The Personhood-Gate Handoff Re-Perceived Effects The Witnessing Spine Conferred Existence Education Research and Portfolio Links Full Curriculum Vitae resume and source-matched downloads. Updated 2026-09-20. Zain Dana Harper Zain Dana Harper | Full Curriculum Vitae Full Curriculum Vitae resume and source-matched downloads. Updated 2026-09-20."
        },
        {
          "label": "Portfolio",
          "href": "portfolio.html",
    ...
    },
    {
      ...
      "routes": [
        ...
        },
        {
          ...
          "searchText": "Products, by domain. Detailed registry, short map linked Agent systems 14 records Flywheel Status Release Telos Status Release Forum Status Release Learn Status Release Relay Status Release Plexus Status Release Mneme Status Release Canon Status Release Bulletin Status Release Proof Surface Status Release behavior-transform.io Status Release Sofer Status Release Bounds Status Release Accountable Surface Status Release Evaluation and verification 18 records Flywheel Status Release Service Desk Incident Environment Status Release Index Status Release Forum Status Release Crucible Status Release EMET Status Release Mneme Status Release Canon Status Release Engine Revival Status Release BRender Archival Status Release Proof Surface Status Release Isomorph Status Release Bounds Status Release Gate Status Release Accountable Surface Status Release Model Provenance Validator Status Release Repo Proof Index Status Release Articulate Status Release Security and privacy 18 records EMET Status Release Proof Surface Status Release Phantom Status Release behavior-transform.io Status Release Array Status Release Seed Status Release Sofer Status Release Isomorph Status Release Bounds Status Release ORCA Status Release Gate Status Release Accountable Surface Status Release Public Surface Sweeper Status Release Model Provenance Validator Status Release Secret Redact IO Status Release Agent Hook Pack Status Release Repo Proof Index Status Release Kun Status Release Developer infrastructure 26 records Flywheel Status Release Telos Status Release Index Status Release Gather Status Release Forum Status Release EMET Status Release BuildLang Status Release Relay Status Release Plexus Status Release Canon Status Release Studio Engine Status Release Retro Engine Status Release Engine Revival Status Release BRender Archival Status Release ENB Runtime Core Status Release SkyrimBridge Status Release behavior-transform.io Status Release Gate Status Release Public Surface Sweeper Status Release Secret Redact IO Status Release Agent Hook Pack Status Release Repo Proof Index Status Release Chorus Status Release RAW Status Release Kun Status Release Articulate Status Release Graphics and media 12 records Telos Status Release BuildLang Status Release Studio Engine Status Release Build Color Status Release Retro Engine Status Release Engine Revival Status Release BRender Archival Status Release Elder ENB Status Release Truth ENB Status Release ENB Runtime Core Status Release SkyrimBridge Status Release RAW Status Release Research and education 7 records Gather Status Release Crucible Status Release Learn Status Release Engine Revival Status Release BRender Archival Status Release Chorus Status Release Articulate Status Release Publicly listed Zentropy Labs product records, including controlled-private boundary pages, grouped by domain. Products, by domain. Product catalog Publicly listed Zentropy Labs product records, including controlled-private boundary pages, grouped by domain."
        },
        {
          "label": "Bulletin",
          "href": "bulletin.html",
        ...
        },
        {
          ...
          "summary": "A plain guide to the site: four ways in, one worked example of re-derivable, how to read the charts and what the site does not claim.",
          "primary": false,
          "searchText": "Start here In short Four ways in If you came to read If you follow AI policy If you want to try the tools If you want to hire or work together What re-derivable means, in one example How to read the charts and diagrams How AI assistance is labeled What this site does not claim Words you will meet A plain guide to the site: four ways in, one worked example of re-derivable, how to read the charts and what the site does not claim. Start here Start here A plain guide to the site: four ways in, one worked example of re-derivable, how to read the charts and what the site does not claim."
        },
        {
          "label": "Glossary",
          "href": "glossary.html",
          "summary": "The terms this site uses often, in plain words, each with a fixed link.",
          "primary": false,
          "searchText": "Glossary In short Terms Agent AI-assisted Benchmark Canonical dossier Does not prove Drift Evaluation Evaluator Honest null How we know Incident Match Misalignment Operator Oracle Pass@1 Re-derivable Receipt Sandbox Source role Statistically significant Unverifiable Verdict Wilson interval Witness The terms this site uses often, in plain words, each with a fixed link. Glossary Glossary The terms this site uses often, in plain words, each with a fixed link."
        },
        {
          "label": "Articulate",
          "href": "articulate.html",
          "summary": "Articulate is a Python command-line tool that checks prose for hedging, filler, stock phrasing and other patterns common in machine-written text, and scores how machine-textured a passage reads. Its checks run locally with no network call, and a check can leave a receipt that replays the verdict later and keeps no verbatim source text.",
          "primary": false,
          "maturity": "shipped",
          "searchText": "Articulate Articulate is a Python command-line tool that checks prose for hedging, filler, stock phrasing and other patterns common in machine-written text, and scores how machine-textured a passage reads. Its checks run locally with no network call, and a check can leave a receipt that replays the verdict later and keeps no verbatim source text. prose checks in CI and pre-commit review of AI-assisted writing content-free audit receipts local prose checker stable v0.4.1 on GitHub and PyPI shipped Evaluation and verification Developer infrastructure Research and education shipped Articulate is a Python command-line tool that checks prose for hedging, filler, stock phrasing and other patterns common in machine-written text, and scores how machine-textured a passage reads. Its checks run locally with no network call, and a check can leave a receipt that replays the verdict later and keeps no verbatim source text."
        }
      ],
      "prefixes": [
        "systems/",
    ...
    },
    {
      ...
      "routes": [
        ...
        },
        {
          ...
          "summary": "Review debt, verifier independence, honest nulls, labor, and machines whose claims anyone can check.",
          "primary": false,
          "maturity": "Long-form essay · 2026",
          "searchText": "No Receipt, No Accept Long-form essay · 2026 Review debt, verifier independence, honest nulls, labor, and machines whose claims anyone can check. Long-form essay · 2026 Review debt, verifier independence, honest nulls, labor, and machines whose claims anyone can check."
        }
      ],
      "prefixes": [
        "security-"
    ...
    },
    {
      ...
      "routes": [
        ...
        },
        {
          ...
          "searchText": "Essays Who Knew First What the Label Changes The Second Hearing The Sandbox Was Never Just a Box LTJ Bukem: The Man Behind the Atmosphere Borrowed Ground An open letter on checking the machines A witness should not become a ruler Growth Needs a Before Availability Is Not Reach Verified Is Not Trustworthy Conferred Existence One premise Why a machine-age reader should care What is actually claimed, and what isn't The thread, and where it goes Essays and public notes from Project Telos on systems, verification, artificial minds, creative work, accountability, and model-era engineering practice. Essays Writing Essays and public notes from Project Telos on systems, verification, artificial minds, creative work, accountability, and model-era engineering practice."
        },
        {
        ...
        },
        {
          ...
          "searchText": "Writing and research Start here Who Knew First Frontier Safety briefing An open letter on checking the machines Follow the subject that has hold of you. AI and frontier systems Psychology, trauma, and repair Education and access Tools, systems, and verification Music and listening Abstract art and visual systems Essays and briefings, in one index. Who Knew First What the Label Changes The Second Hearing The Sandbox Was Never Just a Box LTJ Bukem: The Man Behind the Atmosphere Borrowed Ground Frontier Safety briefing An open letter on checking the machines A witness should not become a ruler Growth Needs a Before Availability Is Not Reach Five evidence lanes, one OpenAI and Hugging Face incident Models Propose, Oracles Dispose No Receipt, No Accept Pick the Lock for Everyone The Summary Is Not the Record Verified Is Not Trustworthy Conferred Existence Eight records on the same spine. Papers Notes Archived corpora Four more papers from the research program. Different forms, one review boundary. Recurring briefings Incident dossiers Essays and notes Research record Evidence-led reading paths across frontier AI, verification, psychology, education, tools, music, and abstract art, plus an eight-record research archive. Writing and research Publications Essays, briefings, and research by Zain Dana Harper Evidence-led reading paths across frontier AI, verification, psychology, education, tools, music, and abstract art, plus an eight-record research archive."
        },
        {
        ...
        },
        {
          ...
          "searchText": "Frontier Safety Briefing daily source record baseline A dated evidence index for UK AISI, Anthropic, and frontier AI industry safety developments. It separates source roles and dates, records what changed, and states what each public record does not prove. Each edition ships with stable links, a machine-readable record, and an append-only corrections path. Frontier Safety briefing Recurring briefing. A dated record of safety news from the UK AI Security Institute, Anthropic, OpenAI and others. Each edition separates what a source reports from what it cannot show. Frontier Safety briefing Recurring Briefing · 2026-09-23 A dated monitor of AISI, Anthropic, OpenAI and industry safety records. Each edition keeps reported facts, source roles and limits apart. Frontier Safety briefing Recurring Briefing · 2026-09-23 A dated monitor of AISI, Anthropic, OpenAI and industry safety records. Each edition keeps reported facts, source roles and limits apart. daily source record baseline A dated evidence index for UK AISI, Anthropic, and frontier AI industry safety developments. It separates source roles and dates, records what changed, and states what each public record does not prove. Each edition ships with stable links, a machine-readable record, and an append-only corrections path."
        },
        {
        ...
        },
        {
          ...
          "summary": "An expanded essay on the public tool portfolio, contribution from outside academia, evidence for review and changing educational practice.",
          "primary": false,
          "maturity": "Editorial Essay · 2026-09-09",
          "searchText": "A witness should not become a ruler Editorial Essay · 2026-09-09 An expanded essay on the public tool portfolio, contribution from outside academia, evidence for review and changing educational practice. A witness should not become a ruler editorial essay · verification An expanded essay on the public tool portfolio, contribution from outside academia, evidence for review and changing educational practice. A witness should not become a ruler Editorial Essay · 2026-09-09 An expanded essay on the public tool portfolio, contribution from outside academia, evidence for review and changing educational practice. Editorial Essay · 2026-09-09 An expanded essay on the public tool portfolio, contribution from outside academia, evidence for review and changing educational practice."
        },
        {
        ...
        },
        {
          ...
          "summary": "The spoken edition: one man's account of the harm he has done, and a case for putting power and public claims in AI, art and knowledge on open records, while private lives stay protected.",
          "primary": false,
          "searchText": "Pick the Lock for Everyone In short The confession Black boxes The robe What AI split open A graph and a poem Optional: the steward platform Optional: a creative economy beside the old one Optional: failing in the open I am a living, breathing reaction What boring and concrete looks like The Mad-Happy Scientist The final rise The coda Delivery notes Process note The spoken edition: one man's account of the harm he has done, and a case for putting power and public claims in AI, art and knowledge on open records, while private lives stay protected. Pick the Lock for Everyone Pick the Lock for Everyone · Spoken Edition The spoken edition: one man's account of the harm he has done, and a case for putting power and public claims in AI, art and knowledge on open records, while private lives stay protected."
        },
        {
        ...
        },
        {
          ...
          "summary": "Six test suites ran offline, with no model connected. The first five test accountability, recovery and state handling on their own small test sets. The sixth re-reads saved per-task results from two models: a base model and Flywheel Local Coder 14B, the same model after continued pretraining, meaning further training on new text.",
          "primary": false,
          "searchText": "Flywheel offline benchmark record What the six suites scored Does not prove Limits Method Tally Each suite with its size, result and interval. What each suite asks Limits Unknown Not measured Suites that did not run, and what each one needs. Peer declarations What each tool's public documentation declares, across all 33 rows. Check it yourself Public source files and their digests. Six test suites ran offline, with no model connected. The first five test accountability, recovery and state handling on their own small test sets. The sixth re-reads saved per-task results from two models: a base model and Flywheel Local Coder 14B, the same model after continued pretraining, meaning further training on new text. Flywheel offline benchmark record Flywheel offline benchmark record Six test suites ran offline, with no model connected. The first five test accountability, recovery and state handling on their own small test sets. The sixth re-reads saved per-task results from two models: a base model and Flywheel Local Coder 14B, the same model after continued pretraining, meaning further training on new text."
        },
        {
        ...
        },
        {
          ...
          "summary": "A label can change where people look and make an artwork feel easier to make sense of. It can do that without raising how much people like the work, what they learn from it, how correctly they interpret it, or its artistic value.",
          "primary": false,
          "maturity": "Evidence-Led Visual Essay · 2026-09-25",
          "searchText": "What the Label Changes Evidence-Led Visual Essay · 2026-09-25 A label can change where people look and make an artwork feel easier to make sense of. It can do that without raising how much people like the work, what they learn from it, how correctly they interpret it, or its artistic value. What the Label Changes evidence-led visual essay · art perception A label can change where people look and make an artwork feel easier to make sense of. It can do that without raising how much people like the work, what they learn from it, how correctly they interpret it, or its artistic value. What the Label Changes Evidence-Led Visual Essay · 2026-09-25 A label can change where people look and make an artwork feel easier to make sense of. It can do that without raising how much people like the work, what they learn from it, how correctly they interpret it, or its artistic value. Evidence-Led Visual Essay · 2026-09-25 A label can change where people look and make an artwork feel easier to make sense of. It can do that without raising how much people like the work, what they learn from it, how correctly they interpret it, or its artistic value."
        },
        {
          "label": "The Second Hearing",
          "href": "the-second-hearing.html",
          "summary": "Repeated listening can change liking, prediction, attention and memory in different ways. A replay count records exposure and cannot measure quality or a universal response.",
          "primary": false,
          "maturity": "Evidence Essay · 2026-09-25",
          "searchText": "The Second Hearing Evidence Essay · 2026-09-25 Repeated listening can change liking, prediction, attention and memory in different ways. A replay count records exposure and cannot measure quality or a universal response. The Second Hearing evidence essay · music listening Repeated listening can change liking, prediction, attention and memory in different ways. A replay count records exposure and cannot measure quality or a universal response. The Second Hearing Evidence Essay · 2026-09-25 Repeated listening can change liking, prediction, attention and memory in different ways. A replay count records exposure and cannot measure quality or a universal response. Evidence Essay · 2026-09-25 Repeated listening can change liking, prediction, attention and memory in different ways. A replay count records exposure and cannot measure quality or a universal response."
        },
        {
          "label": "Availability Is Not Reach",
          "href": "availability-is-not-reach.html",
          "summary": "Tutoring has strong trial evidence. An offer of tutoring and its delivery are separate facts, and public claims must keep availability, reach, dosage, staffing, and outcomes apart.",
          "primary": false,
          "maturity": "Public-Interest Analysis · 2026-09-01",
          "searchText": "Availability Is Not Reach Public-Interest Analysis · 2026-09-01 Tutoring has strong trial evidence. An offer of tutoring and its delivery are separate facts, and public claims must keep availability, reach, dosage, staffing, and outcomes apart. Availability Is Not Reach public-interest analysis · education access Tutoring has strong trial evidence. An offer of tutoring and its delivery are separate facts, and public claims must keep availability, reach, dosage, staffing, and outcomes apart. Availability Is Not Reach Public-Interest Analysis · 2026-09-01 Tutoring has strong trial evidence. An offer of tutoring and its delivery are separate facts, and public claims must keep availability, reach, dosage, staffing, and outcomes apart. Public-Interest Analysis · 2026-09-01 Tutoring has strong trial evidence. An offer of tutoring and its delivery are separate facts, and public claims must keep availability, reach, dosage, staffing, and outcomes apart."
        },
        {
          "label": "Five evidence lanes, one OpenAI and Hugging Face incident",
          "href": "briefings/2026-08-26-openai-hugging-face-incident/",
          "summary": "One OpenAI and Hugging Face incident, compared across five kinds of source: legal process, the company report, host logs, independent analysis and vendor fixes.",
          "primary": false,
          "maturity": "Canonical Dossier · 2026-08-27",
          "searchText": "Five evidence lanes, one OpenAI and Hugging Face incident Canonical Dossier · 2026-08-27 One OpenAI and Hugging Face incident, compared across five kinds of source: legal process, the company report, host logs, independent analysis and vendor fixes. Five evidence lanes, one OpenAI and Hugging Face incident Canonical Dossier · 2026-08-27 One OpenAI and Hugging Face incident, compared across five kinds of source: legal process, the company report, host logs, independent analysis and vendor fixes. Canonical Dossier · 2026-08-27 One OpenAI and Hugging Face incident, compared across five kinds of source: legal process, the company report, host logs, independent analysis and vendor fixes."
        },
        {
          "label": "LTJ Bukem: The Man Behind the Atmosphere",
          "href": "ltj-bukem-the-man-behind-the-atmosphere.html",
          "summary": "Danny Williamson’s calm, spacious records come out of a series of musical decisions, shaped by his taste and working habits and by the musicians around him.",
          "primary": false,
          "maturity": "Biographical And Critical Essay · 2026-09-25",
          "searchText": "LTJ Bukem: The Man Behind the Atmosphere Biographical And Critical Essay · 2026-09-25 Danny Williamson’s calm, spacious records come out of a series of musical decisions, shaped by his taste and working habits and by the musicians around him. LTJ Bukem: The Man Behind the Atmosphere biographical and critical essay · music listening Danny Williamson’s calm, spacious records come out of a series of musical decisions, shaped by his taste and working habits and by the musicians around him. LTJ Bukem: The Man Behind the Atmosphere Biographical And Critical Essay · 2026-09-25 Danny Williamson’s calm, spacious records come out of a series of musical decisions, shaped by his taste and working habits and by the musicians around him. Biographical And Critical Essay · 2026-09-25 Danny Williamson’s calm, spacious records come out of a series of musical decisions, shaped by his taste and working habits and by the musicians around him."
        },
        {
          ...
          "primary": false,
          "maturity": "Editorial Analysis · 2026-09-25",
          "searchText": "The Sandbox Was Never Just a Box Editorial Analysis · 2026-09-25 Separate security reports expose a shared question: what can an agent reach, and can the instruments that record its actions remain trustworthy? The Sandbox Was Never Just a Box editorial analysis · agent evaluation Separate security reports expose a shared question: what can an agent reach, and can the instruments that record its actions remain trustworthy? The Sandbox Was Never Just a Box Editorial Analysis · 2026-09-25 Separate security reports expose a shared question: what can an agent reach, and can the instruments that record its actions remain trustworthy? Editorial Analysis · 2026-09-25 Separate security reports expose a shared question: what can an agent reach, and can the instruments that record its actions remain trustworthy?"
        },
        {
          "label": "Borrowed Ground",
          "href": "borrowed-ground.html",
          "summary": "On existence and what our work owes other people.",
          "primary": false,
          "maturity": "Philosophical Essay · 2026-09-25",
          "searchText": "Borrowed Ground Philosophical Essay · 2026-09-25 On existence and what our work owes other people. Borrowed Ground philosophical essay · philosophy On existence and what our work owes other people. Borrowed Ground Philosophical Essay · 2026-09-25 On existence and what our work owes other people. Philosophical Essay · 2026-09-25 On existence and what our work owes other people."
        },
        {
          "label": "An open letter on checking the machines",
          "href": "checking-the-machines.html",
          "summary": "A signed letter on what it would take for a person to question a machine's answer and have that question heard.",
          "primary": false,
          "maturity": "Letter, 19 September 2026, revised 20 September 2026.",
          "searchText": "An open letter on checking the machines Letter, 19 September 2026, revised 20 September 2026. A signed letter on what it would take for a person to question a machine's answer and have that question heard. An open letter on checking the machines Open Letter · 2026-09-20 A signed letter to the people who build AI systems: a person should be able to question a machine&#x27;s answer without first winning an argument with its owner. An open letter on checking the machines open letter · verification A signed letter to the people who build AI systems: a person should be able to question a machine&#x27;s answer without first winning an argument with its owner. An open letter on checking the machines Open Letter · 2026-09-20 A signed letter to the people who build AI systems: a person should be able to question a machine&#x27;s answer without first winning an argument with its owner. Letter, 19 September 2026, revised 20 September 2026. A signed letter on what it would take for a person to question a machine's answer and have that question heard."
        }
      ]
    },
    {
      "label": "Who Knew First",
      "routes": [
        {
          "label": "Who Knew First",
          "href": "who-knew-first.html",
          "summary": "Nine AI agent incidents from 2026, traced from first signal to public account. The record asks who held the facts, how long the public waited and who told it first.",
          "maturity": "Investigation and op-ed. Record 23 September 2026, op-ed 25 September 2026.",
          "searchText": "Who Knew First Investigation and op-ed. Record 23 September 2026, op-ed 25 September 2026. Nine AI agent incidents from 2026, traced from first signal to public account. The record asks who held the facts, how long the public waited and who told it first. Who Knew First Canonical Dossier · 2026-09-25 An op-ed and the record behind it. By the record&#x27;s account, the organization that ran the model held the decisive facts in each of nine AI agent incidents from 2026, and in six of them someone else told the public first. Who Knew First canonical dossier · ai incidents An op-ed and the record behind it. By the record&#x27;s account, the organization that ran the model held the decisive facts in each of nine AI agent incidents from 2026, and in six of them someone else told the public first. Who Knew First Canonical Dossier · 2026-09-25 An op-ed and the record behind it. By the record&#x27;s account, the organization that ran the model held the decisive facts in each of nine AI agent incidents from 2026, and in six of them someone else told the public first. Investigation and op-ed. Record 23 September 2026, op-ed 25 September 2026. Nine AI agent incidents from 2026, traced from first signal to public account. The record asks who held the facts, how long the public waited and who told it first.",
          "primary": true
        }
      ]
    },
...
}`),oe=[`flywheel.html`,`research.html`,`who-knew-first.html`,`studio.html`,`fonts.html`,`hire.html`],se=ae.families.flatMap(e=>e.routes.filter(e=>e.primary).map(t=>({...t,family:e.label,primary:!0}))).sort((e,t)=>oe.indexOf(e.href)-oe.indexOf(t.href)),ce=ae.families.map(e=>({label:e.label,routes:e.routes.filter(e=>!e.primary).map(t=>({...t,family:e.label,primary:!1}))})).filter(e=>e.routes.length),le=ae.externalActions;function ue(e){try{let t=new URL(e||`index.html`,`https://harperz9.github.io/`),n=t.pathname.replace(/^\//,``);return n?n.endsWith(`/`)?n+=`index.html`:(n.split(`/`).pop()||``).includes(`.`)||(n+=`.html`):n=`index.html`,n+t.search+t.hash}catch{return``}}function T(e){let t=ue(e),n=t.split(`#`)[0].split(`?`)[0];for(let e of ae.families)if(e.routes.some(e=>{let r=ue(e.href);return r===t||r.split(`#`)[0].split(`?`)[0]===n?!0:(e.aliases||[]).some(e=>{let r=ue(e);return r===t||r.split(`#`)[0].split(`?`)[0]===n})}))return e.label;for(let e of ae.families){let t=n.replace(/\.html$/,``);if((e.prefixes||[]).some(e=>t.startsWith(e)))return e.label}return``}var E=JSON.parse(`{
  ...
  "systems": [
    {
      ...
      "evidence": [
        {
          ...
          "type": "release",
          "label": "Flywheel v1.0.4",
          "href": "https://github.com/HarperZ9/flywheel/releases/tag/v1.0.4",
          "date": "2026-09-25",
          "status": "verified",
          "summary": "The v1.0.4 GitHub release, titled Flywheel 1.0.4, was published at 2026-09-26T01:50:41Z, and the v1.0.4 tag resolves to source commit 5d8b89d5f51e7ee3c096a1921dd4e601c8c75dd7. The release attaches Flywheel-Setup-1.0.4-x64.exe at 56,355,754 bytes with SHA-256 a91b9bc71862f89b72c1a4655576134bbd0cd0d762128c9b05a1f186304a2881, a SHA256SUMS.txt that lists the same value, and a frozen gateway smoke receipt reporting PASS for 1.0.4. Installed acceptance passed on the tagged commit. The installer is unsigned; this is distribution evidence, not proof of clean-machine installation."
        },
        {
          "id": "flywheel-pypi-v1-0-4",
          "type": "release",
          "label": "flywheel-verify 1.0.4 on PyPI",
          "href": "https://pypi.org/project/flywheel-verify/1.0.4/",
          "date": "2026-09-25",
          "status": "verified",
      ...
      "limitations": [
        ...
        "Native lane bundling covers ten Python lanes from hash-pinned vendored source. The node lanes learn and telos, and calibrate-pro, resolve from a source checkout today and are not claimed as natively bundled; articulate installs from PyPI (articulate-writing 0.4.0 as of Flywheel 1.0.3).",
      ...
      "releaseState": "stable Python engine v1.0.4; unsigned Windows desktop v1.0.4; ten Python lanes bundle from vendored source; no measured accuracy uplift over single-shot; clean-machine, mobile, and node-lane bundling not claimed"
    },
    {
    ...
    },
    {
      "id": "articulate",
      "name": "Articulate",
      "purpose": "Articulate is a Python command-line tool that checks prose for hedging, filler, stock phrasing and other patterns common in machine-written text, and scores how machine-textured a passage reads. Its checks run locally with no network call, and a check can leave a receipt that replays the verdict later and keeps no verbatim source text.",
      "useCases": [
        "prose checks in CI and pre-commit",
        "review of AI-assisted writing",
        "content-free audit receipts"
      ],
      "href": "articulate.html",
      "sourceHref": "https://github.com/HarperZ9/articulate",
      "domains": [
        "evaluation-verification",
        "developer-infrastructure",
        "research-education"
      ...
      "family": "verification",
      "architectureRole": "local-prose-checker",
      "audiences": [
        "writers and editors",
        "evaluation engineers",
        "software engineers"
      ...
      "deploymentContexts": [
        "local development workspaces",
        "review and CI lanes",
        "editors through the Language Server Protocol"
      ],
      "maturity": "shipped",
      "placement": "featured",
      "accessMode": "install",
      "entryCommand": "python -m pip install articulate-writing==0.4.1",
      "verificationCommand": "articulate check notes.md --mode technical-docs/explain --gate",
      "evidence": [
        {
          "id": "articulate-release-v0-4-1",
          "type": "release",
          "label": "Articulate v0.4.1",
          "href": "https://github.com/HarperZ9/articulate/releases/tag/v0.4.1",
          "date": "2026-09-24",
          "status": "verified",
          "summary": "The v0.4.1 GitHub release is public, not draft, and not prerelease. The annotated tag object is b15378d849384393d1f0b40bec4d1580e30a9321; the peeled source commit is eefba5b2e8e30d6c62ef1bf9e6eaa0d0dbc0a78d. No release assets are attached to this GitHub release."
        },
        {
          "id": "articulate-pypi-v0-4-1",
          "type": "release",
          "label": "articulate-writing 0.4.1 on PyPI",
          "href": "https://pypi.org/project/articulate-writing/0.4.1/",
          "date": "2026-09-24",
          "status": "verified",
          "summary": "PyPI serves articulate-writing 0.4.1. The wheel SHA-256 is 6a89c91243d77196e3122a94a849fdd2faa8cc55202999095b0e1bacfdde8c45; the source archive SHA-256 is ba2ef4fd994477f10a6bf15121160b5852092036354a6e3a09983b4af90e020c. This is distribution evidence, not proof of detection quality or independent use."
        }
      ],
      "limitations": [
        "A clean check means no known pattern fired; it does not establish that the prose is true, clear, or written by a person.",
        "The pattern rules are the author's; agreement with human editors has not been measured on this page's evidence.",
        "The judge, fix, and polish editing tools call a language model, so the no-network property covers the checks and receipts only.",
        "A content-free receipt still records which rule fired on which line, which narrows a closed-vocabulary match to that rule's word list."
      ],
      "boundary": "Run on prose you are authorized to review. The tool is not built or offered for evading AI detection.",
      "inputs": [
        "prose files in Markdown, plain text, or LaTeX",
        "a writing mode or register profile"
      ],
      "outputs": [
        "gate verdicts with per-line findings",
        "machine-texture scores",
        "Match, Drift, or Unverifiable receipt replays",
        "SARIF 2.1.0 reports"
      ],
      "dependencies": [],
      "related": [
      ...
      "lastVerified": "2026-09-25",
      "primaryDomain": "evaluation-verification",
      "productType": "local prose checker",
      "releaseState": "stable v0.4.1 on GitHub and PyPI"
    }
  ]
}
`),de=E.systems;de.filter(e=>e.placement===`featured`);var fe=E.domains,pe=de.flatMap(e=>e.evidence.map(t=>({...t,systemId:e.id}))).sort((e,t)=>t.date.localeCompare(e.date));function me(e){return de.find(t=>t.id===e)}var D=`{
