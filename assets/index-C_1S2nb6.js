  ...
  "systems": [
    {
      "id": "flywheel",
      "name": "Flywheel",
      "purpose": "Run a verified-inference platform and native desktop client in which models perceive through witnessed tools, act through permission gates, journal their work, and re-check outcomes through integrated lanes.",
      "useCases": [
    ...
    },
    {
      "id": "engine-revival",
      "name": "Engine Revival",
      "purpose": "Maintain public-safe metadata, schemas, validators, target matrices, reproduction recipes, evidence packets, and reports for reviving historical game engines, SDKs, rendering libraries, CGI toolkits, and studio technology.",
      "useCases": [
        "preserve",
    ...
    },
    {
      ...
      "purpose": "Rebuild and document Argonaut BRender from its public MIT source with an out-of-tree CMake harness, a 21-rung native verification ladder, reproducible render captures, provenance records, and public-safe release packaging.",
      "useCases": [
        "verify",
    ...
    },
    {
      "id": "sofer",
      "name": "Sofer",
      "purpose": "Sofer is a private Python security-operations platform and orchestration runtime. It accepts an authorized engagement scope, objectives and targets, selected modules and model backends, operator decisions, and collected evidence; it routes specialist work and runs scoped reconnaissance, adversarial testing, defensive analysis, campaign workflows, finding management, and disclosure, producing run state, assessment results, findings, reports, evidence artifacts, receipts, and handoff records.",
      "useCases": [
    ...
    },
    {
      "id": "bounds",
      "name": "Bounds",
      "purpose": "Verify trust across agent actions, runtime observations, and releases by detecting intent drift and unsupported history claims, running explicit sensors and guards, and emitting evidence-backed receipts and proof chains.",
      "useCases": [
