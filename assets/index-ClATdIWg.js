...
`),E=T.systems;E.filter(e=>e.placement===`featured`);var de=T.domains,fe=E.flatMap(e=>e.evidence.map(t=>({...t,systemId:e.id}))).sort((e,t)=>t.date.localeCompare(e.date));function pe(e){return E.find(t=>t.id===e)}var me=`{
  ...
  "records": [
    ...
    },
    {
      ...
      "date": "2026-09-08",
      "status": "verified",
      "summary": "Gather v1.7.1 GitHub release preserves exact UTF-8 source text in new corpus writes while providing a readable LF-normalized view for selection; published assets match the verified wheel, source archive, and checksum hashes from source commit cb35c6d513e63fceca74c8eafcd1faee4347ea32.",
      "systemId": "gather"
    },
    {
      "id": "gather-pypi-v1-7-1",
      ...
      "date": "2026-09-08",
      "status": "verified",
      "summary": "PyPI serves gather-engine 1.7.1; publication verification matched PyPI and GitHub download-back hashes, checked 64 Python modules and 132 source archive files, clean installed the Windows wheel, exercised CLI/MCP context selection, and refused tampered corpus selection while preserving does-not-prove limits.",
      "systemId": "gather"
    },
    {
      "id": "flywheel-release-v0-6-0",
      ...
      "date": "2026-09-08",
      "status": "verified",
      "summary": "Flywheel v0.6.0 GitHub release, source commit, installer metadata, Windows tag-candidate acceptance attempt 2, Continue with agent, durable Index workspace-map jobs, and local Ollama usage retention are verified; clean-VM, mobile, provider/model calls, and general model uplift are not claimed.",
      "systemId": "flywheel"
    },
    {
      "id": "flywheel-pypi-v0-6-0",
      ...
      "date": "2026-09-08",
      "status": "verified",
      "summary": "PyPI serves flywheel-verify 0.6.0 with source verification across 592 Python source files and 601 wheel RECORD entries; the receipt does not include an installed runtime check, and clean-machine installation is not claimed.",
      "systemId": "flywheel"
    },
    {
      "id": "relay-release-v0-2-0",
      ...
      "date": "2026-09-08",
      "status": "verified",
      "summary": "Relay 0.2.0 GitHub release assets, hashes, tag binding, clean --no-index wheel install, and MCP synthetic controls verified; PyPI relay-agent publication or install is not claimed.",
      "systemId": "relay"
    },
    {
      "id": "forum-route-preflight-skill-v0-1-0",
