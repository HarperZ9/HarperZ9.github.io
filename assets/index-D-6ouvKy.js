  ...
  "systems": [
    {
      "id": "flywheel",
      "name": "Flywheel",
      "purpose": "Serve as the primary platform for model-neutral agent work: engine, desktop client, gated tool use, receipt-backed inference, and extension lanes.",
      "useCases": [
        "agent workflow orchestration",
        "platform extension host",
      ...
      "evidence": [
        {
          ...
          "date": "2026-08-28",
          "status": "verified",
          "summary": "The v0.3.10 public release is current, and the public GitHub description identifies Flywheel as the one platform for the engine and native desktop client."
        }
      ],
      "limitations": [
    ...
    },
    {
      "id": "retro-engine",
      "name": "Retro Engine",
      "purpose": "Serve as the Retro Systems Lab play pillar: an interactive browser studio for owned pixel, palette, shader, and CRT experiments.",
      "useCases": [
        "play",
      ...
      "limitations": [
        ...
        "Browser, GPU, and font rendering can differ by host, so captures are bounded media evidence rather than performance claims."
      ],
      ...
      "inputs": [
        "owned images or browser-rendered frames",
        "palette and shader settings"
      ],
      "outputs": [
        "interactive browser render",
        "static capture with provenance"
      ],
      "dependencies": [],
      "related": [
        "flywheel",
    ...
    },
    {
      "id": "engine-revival",
      "name": "Engine Revival",
      "purpose": "Serve as the Retro Systems Lab preserve pillar: a public MIT evidence spine for historical engine and rendering-library revival records.",
      "useCases": [
        "preserve",
      ...
      "evidence": [
        {
          ...
          "date": "2026-08-28",
          "status": "verified",
          "summary": "The public main and v0.1.0 release resolve to 0af6d527860a63c418b5775dc0efe9ba89557604. Engine Revival is MIT; it records local 12-target materializer scope separately from imported external 21-target BRender evidence."
        }
      ],
      "limitations": [
      ...
      "inputs": [
        ...
        "license and recipe review receipts",
        "imported BRender release evidence"
      ],
      "outputs": [
        "preservation status page",
    ...
    },
    {
      ...
      "purpose": "Serve as the Retro Systems Lab verify pillar: a specific BRender restoration surface that stays separate from generic Retro Engine media.",
      "useCases": [
        "verify",
      ...
      "evidence": [
        {
          ...
          "date": "2026-08-28",
          "status": "verified",
          "summary": "The public main and v0.1.1 release resolve to 11b5a8d539e911a9c07991b751402a7d51bf1bde. The repo is AGPL-3.0-or-later, upstream BRender MIT is referenced not vendored, and 21/21 native CTest targets are recorded."
        }
      ],
      "limitations": [
      ...
      "inputs": [
        "BRender public repository evidence",
        "restoration receipts and license notes"
      ],
      "outputs": [
        "BRender archival status page",
    ...
    },
    {
      ...
      "purpose": "Provide controlled offensive-security, adversarial-AI, and high-consequence review through private, written-scope engagements without publishing operational capability.",
      "useCases": [
        "authorized adversarial evaluation",
        "high-consequence security review",
        "engagement-scoped attack and defense analysis",
        "private or embargoed safety handoffs"
      ],
      "href": "private-practice.html",
      "sourceHref": null,
      "domains": [
      ...
      "evidence": [
        {
          ...
          "date": "2026-08-28",
          "status": "verified",
          "summary": "The public page groups private capability families without distributing protected methods."
        }
      ],
      "limitations": [
      ...
      "boundary": "Written authorization, a defined scope, secure intake, and engagement-specific review are required before any private capability, protected test material, recipient-specific method, or version-sensitive finding is discussed or used.",
      "inputs": [
        "authorized adversarial evaluation inputs",
        "written scope and safe-harbor terms",
        "operator-defined constraints"
      ],
      "outputs": [
        "authorized adversarial evaluation result",
        "private or embargoed handoff packet",
        "reviewable verification record"
      ],
      "dependencies": [],
      "related": [
