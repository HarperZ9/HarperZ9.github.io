...
test("rendered nav marks only the matching fragment route as the current page", () => {
  const mount = {
    html: "",
    set innerHTML(value) { this.html = value; },
    get innerHTML() { return this.html; },
  ...
  const doc = {
    location: { pathname: "/hire.html", search: "", hash: "#engineering-path" },
    getElementById(id) { return id === "site-nav" ? mount : null; },
  };
  ...
  assert.doesNotMatch(mount.innerHTML, /href="hire\.html" aria-current="page"/);
  assert.doesNotMatch(mount.innerHTML, /href="hire\.html#technical-operations-path" aria-current="page"/);
  assert.equal((mount.innerHTML.match(/aria-current="page"/g) || []).length, 1);
  assert.match(mount.innerHTML, /class="is-active" href="hire\.html"/);
});

test("rendered nav marks one duplicate primary route as the current page", () => {
  const mount = {
    html: "",
    set innerHTML(value) { this.html = value; },
    get innerHTML() { return this.html; },
  ...
  const doc = {
    location: { pathname: "/hire.html", search: "", hash: "" },
    getElementById(id) { return id === "site-nav" ? mount : null; },
  };
...
test("rendered nav keeps local destinations rooted from nested system pages", () => {
  const mount = {
    html: "",
    set innerHTML(value) { this.html = value; },
    get innerHTML() { return this.html; },
  ...
  const doc = {
    location: { pathname: "/systems/relay.html", search: "" },
    getElementById(id) { return id === "site-nav" ? mount : null; },
  };
  ...
  assert.match(mount.innerHTML, /href="\/overview\.html"/);
  assert.match(mount.innerHTML, /href="\/systems\/relay\.html" aria-current="page"/);
