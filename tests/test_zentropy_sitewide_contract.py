...
REVIEWED_ASSET_REVISIONS = {
    ...
    "system/nav.js": "20260907-simple-menu",
    ...
    "system/font-marketplace.css": "20260907-original-preview",
    "system/font-specimen.js": "20260907-original-preview",
    "system/project-router.js": "20260907-gallery-projects",
    "system/creative-workspace.js": "20260907-gallery-projects",
    "system/creative-workspace.css": "20260907-workspace",
    "system/retro-studio.js": "20260907-gallery-projects",
    "system/loom-studio.js": "20260907-gallery-projects",
    "system/studio.js": "20260907-gallery-projects",
...
def test_shared_nav_renders_zentropy_brand_and_desktop_gpu_gate() -> None:
    ...
    assert 'NAV_PRIMARY_ROUTES.map((item) => navLink(item, active, routePath, true)).join("")' in nav
    assert 'NAV_MENU_GROUPS.map((group) => menuGroup(' in nav
